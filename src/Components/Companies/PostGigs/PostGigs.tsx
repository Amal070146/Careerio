                ...
                <div className={styles.PostGigWorkWrapper}>
                    <div className={styles.HeaderSection2}>
                        ...
                        <div className={styles.ContentSession}>
                            ...
                            <p>
                                Are you a company seeking the top talents? Look
                                no further! We are your trusted partner for gig
                                work postings, connecting you with the best
                                freelancers, contractors, and gig workers in the
                                industry. Partner with us today and experience
                                the difference in gig work postings.
                            </p>
                            <Link to="/formpostgig">Post a Gig!</Link>
                        </div>
                    </div>
                                ...
                                ({
                                    ...
                                    <div className={styles.IndividualWrapper}>
                                        ...
                                        <div className={styles.SecondDiv}>
                                            ...
                                            <p>{description}</p>
                                            <div
                                                className={styles.StacksWrapper}
                                            >
                                                {stacks.map(
                                                    (stacks, index: any) => (
                                                        <p key={index}>
